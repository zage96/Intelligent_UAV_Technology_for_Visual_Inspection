...
''' Program that receives an image and detects the coordantes of an specifiec color object, printing the dots of the center of the image and the detected target '''
